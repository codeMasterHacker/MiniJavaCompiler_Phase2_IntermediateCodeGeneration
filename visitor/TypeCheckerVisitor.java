...
public class TypeCheckerVisitor implements GJVisitor<String, SymbolTableEntry> 
{
    ...
    */
    ...
    public String visit(MethodDeclaration n, SymbolTableEntry classEntry)
    {
        ...
        //can return a variable or int or int[] or boolean
    ...
    */
    ...
    public String visit(FormalParameter n, SymbolTableEntry methodEntry) 
    {
        ...
        return n.f0.accept(this, null); //* f0 -> Type()
    }
    ...
    */
    ...
    public String visit(IfStatement n, SymbolTableEntry methodEntry) 
    {
        ...
        //in case bool is a variable
        SymbolTableEntry entry = methodEntry.get_tableEntry(bool);
        String type;
        ...
        {
            System.out.println("\nType Checking Error at If Statement");
            System.out.println("The if statement evaluates to '" + type + "'");
            System.out.println("The if statement must evaluate to 'boolean'");
        }
    ...
    */
    ...
    public String visit(WhileStatement n, SymbolTableEntry methodEntry) 
    {
        ...
        if (!type.equals("boolean"))
        {
            System.out.println("\nType Checking Error at While Statement");
            System.out.println("The while statement evaluates to '" + type + "'");
            System.out.println("The while statement must evaluate to 'boolean'");
        }
    ...
    */
    ...
    public String visit(PrintStatement n, SymbolTableEntry methodEntry) 
    {
        ...
        //in case integer is a variable
        SymbolTableEntry entry = methodEntry.get_tableEntry(integer);
        String type;
        ...
        if (!type.equals("int"))
        {
            System.out.println("\nType Checking Error at Print Statement");
            System.out.println("The print statement prints a '" + type + "'");
            System.out.println("The print statement must print an 'int'");
        }
